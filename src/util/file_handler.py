...
class File_Handler():
    ...
    def __init__(self):
        ...
        self.icons_path = Path.joinpath(self.resource_path, "icons")
        ...
        self.used_icon_path = Path.joinpath(self.icons_path, "apple_icon.ico")
        self.used_font_path = Path.joinpath(self.icons_path, "Eurostile LT Std.otf")
